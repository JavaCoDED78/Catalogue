...
public class ProductControllerIT {
    ...
    @Test
    void receiveProduct_ProductExists_ReturnsProductPage() throws Exception {
        // given
    ...
    @Test
    void receiveProduct_ProductDoesNotExist_ReturnsError404Page() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/catalogue/products/1")
                .with(user("j.dewar").roles("MANAGER"));
    ...
    @Test
    void receiveProduct_UserIsNotAuthorized_ReturnsForbidden() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/catalogue/products/1")
                .with(user("j.daniels"));
    ...
    @Test
    void receiveEditProductPage_ProductExists_ReturnsProductEditPage() throws Exception {
        // given
    ...
    @Test
    void receiveEditProductPage_ProductDoesNotExist_ReturnsError404Page() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/catalogue/products/1/edit")
                .with(user("j.dewar").roles("MANAGER"));
    ...
    @Test
    void receiveEditProductPage_UserIsNotAuthorized_ReturnsForbidden() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/catalogue/products/1/edit")
                .with(user("j.daniels"));
